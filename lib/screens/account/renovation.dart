...
class RenovationScreen extends StatefulWidget {
  @override
  _RenovationScreen createState() => _RenovationScreen();
}

class _RenovationScreen extends State<RenovationScreen> {
  ...
  void Getlist() async {
    ...
    AccountsList response = await client.getAllAccountsRenovation(data,
