...
class ActiveworkScreen extends StatefulWidget {
  @override
  _ActiveworkScreen createState() => _ActiveworkScreen();
}

class _ActiveworkScreen extends State<ActiveworkScreen> {
 ...
 appStore.setLoading(true);
    TechniciansList response = await client.getActiveTechnicianById(data,
